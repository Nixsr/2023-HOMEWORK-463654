...
public class LabirintoBuilderTest {
	...
	public void testTrilocale(){
		...
		assertEquals(nomeStanzaFinale, trilocale.getStanzaFinale().getNome());
	...
	public void testLabirintoCompletoConTutteLeStanze() {
		...
		Labirinto labirintoCompleto = this.labirintoBuilder
				...
				.addAdiacenza("Aula 1", nomeStanzaFinale,"nord")
				.addAdiacenza(nomeStanzaFinale, "Aula 1", "sud")
		...
		assertEquals(nomeStanzaFinale, labirintoCompleto.getStanzaFinale().getNome());
